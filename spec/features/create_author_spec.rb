...
RSpec.feature "Create Author", type: :feature do
  ...
  feature "create success" do
    scenario "Admin creates a new author" do
      fill_in "author[name]", with: Faker::Lorem.characters(number: Settings.name_author)
      fill_in "author[description]", with: Faker::Lorem.characters(number: Settings.description_author)
      click_button "commit"
